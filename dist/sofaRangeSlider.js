 ...
 */
;(function (angular) {
angular.module('sofa-range-slider.tpl.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('sofa-range-slider.tpl.html',
...
angular.module('sofa.rangeSlider', [
    'sofa-range-slider.tpl.html'
])
    .directive('sofaRangeSlider', function () {
        ...
        ['webkit', 'Moz', 'O', 'ms'].every(function (prefix) {
            ...
            if (window.document.body.style[e] !== undefined) {
        ...
        return {
            ...
            templateUrl: 'sofa-range-slider.tpl.html',
